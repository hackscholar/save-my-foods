...
class Settings(BaseSettings):
    ...
    supabase_url: "https://vkdjwwrqiorbsdjmojjq.supabase.co"
    # TODO: Add your Supabase anonymous/public key from https://app.supabase.com/project/_/settings/api
    supabase_anon_key: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZramR3d3JxaW9yYnNkam1vampxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzE2MzY3NzEsImV4cCI6MjA0NzIxMjc3MX0.b44QX1Q5z94Ou3m27f0uU-hL7s8K98K1-H3G7LQO8"
